        ...
        for i in range(0, len(records), chunk_size):
            ...
            for record in chunk:
                try:
                    ...
                    failed.append({"data": record, "error": str(e)})
    ...
    def bulk_update(
        ...
        *,
        ...
        for i in range(0, len(updates), chunk_size):
            ...
            for update in chunk:
                try:
                    result = self.factory.update(model, update["entity_id"], update["data"])
                    succeeded.append(result)
                except Exception as e:
                    failed.append({"data": update, "error": str(e)})
        ...
        for i in range(0, len(entity_ids), chunk_size):
            ...
            for entity_id in chunk:
                try:
                    ...
                    failed.append({"data": {"entity_id": entity_id}, "error": str(e)})
