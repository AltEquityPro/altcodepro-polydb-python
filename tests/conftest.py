...
class TestConfig:
    ...
    def __init__(self, opts: Any) -> None:
        ...
        env_file = opts.env_file or os.path.join(os.path.dirname(__file__), ".env.test")
    ...
    def has_azure(self) -> bool:
        return bool(self.azure_conn)

    def has_aws(self) -> bool:
        return bool(self.aws_key)

    def has_gcp(self) -> bool:
        return bool(self.gcp_project and self.fs_host)

    def has_vercel(self) -> bool:
        return bool(self.vercel_kv)

    def has_redis(self) -> bool:
        return bool(self.redis_cache)
